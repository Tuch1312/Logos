...
//	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (automaticFill == false) {
			...
			Date dataInizio = new Date(Long.parseLong(request.getParameter("dataInizio"))); 
			...
			Date oraInizioLezioni = new Date(Long.parseLong(request.getParameter("oraInizioLezioni")));
