...
/**
 * Servlet implementation class EliminaCorsoServlet
 */
@WebServlet("/EliminaCorsoServlet")
public class EliminaCorsoServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EliminaCorsoServlet() {
        super();
